...
<head>
    <title>SEMESTER ANTARA FILKOM UB</title>
...
<body>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    SI SA <i class="clip-clip"></i>FILKOM UB
                </a>
                <!-- end: LOGO -->
            </div>
            <div class="navbar-tools">
                ...
                <ul class="nav navbar-right">
                    ...
                    <li class="dropdown current-user">
                        <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
                            <img class="circle-img" width='35' alt="" src="<?php echo base_url('uploads/foto_user/'.$this->session->userdata('foto'));?>"> 
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <?php 
                                    echo anchor('pengguna/profil', '<i class="fa fa-user" aria-hidden="true"></i> Profil'); 
                                    ?>
                            </li>
                            ...
                            <li>
                                <?php
                                    echo anchor('login', '<i class="fa fa-sign-out" aria-hidden="true"></i> Log Out');
                                    ?>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="main-container">
        <div class="navbar-content">
            ...
            <div class="main-navigation navbar-collapse collapse">
                ...
                <ul class="main-navigation-menu">
                    ...
                    // $sql_menu = "select * from tabel_menu where id in(select id_menu from t_pengguna_rule where id_peran=$id_peran)and is_main_menu=0" ;
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="page-header">
                            <h1>SEMESTER ANTARA <small>Tahun Ajaran &amp; 2018/2019 </small></h1>
                        </div>
        ...
        <script src="assjquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
